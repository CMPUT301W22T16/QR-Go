...
public class QRArrayAdapterTest{
    ...
    private QRListDisplayContainer qrDispCont1 = new QRListDisplayContainer(123, "1234", null, null, null, null, null, null);
    ...
    public void TestUserQRConstructor() {
        for(int i = 0; i < 10; i++) {
            qrDisplays.add(new QRListDisplayContainer(i+20, Integer.toString(i+10), null, null, null, null, null, null));
        }
