...
public final class ActivityCodeScannerBinding implements ViewBinding {
  ...
  private ActivityCodeScannerBinding(@NonNull FrameLayout rootView,
  ...
  public static ActivityCodeScannerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_code_scanner, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityCodeScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCodeScannerBinding((FrameLayout) rootView, scannerView);
    }
